...
namespace Server.StatusChecker {
    using System;
    ...
    public partial class SMSService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public SMSService() {
            this.Url = global::Server.Properties.Settings.Default.Server_StatusChecker_SMSService;
        ...
        /// <remarks/>
        public void GetStatusAsync(string msisdn) {
            this.GetStatusAsync(msisdn, null);
        }
        
        /// <remarks/>
        public void GetStatusAsync(string msisdn, object userState) {
            ...
            this.InvokeAsync("GetStatus", new object[] {
                        msisdn}, this.GetStatusOperationCompleted, userState);
        }
